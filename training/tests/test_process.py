...
def test_processs_suite(test_step, steps_data):
    """Test suite function for data processing steps.

    Args:
        test_step (str): The current step being executed.
        steps_data (object): Holds data between steps.
...
def get_features_step(steps_data):
    """Step function to generate design matrices and validate them.
...
def rename_columns_step(steps_data):
    """Step function to rename columns and assert column names.
